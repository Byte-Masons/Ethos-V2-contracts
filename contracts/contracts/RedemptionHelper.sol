...
contract RedemptionHelper is LiquityBase, Ownable, IRedemptionHelper {
    ...
    */
        ...
        external override
    {
        ...
        totals.collDebtAtStart = getEntireSystemDebt(_collateral);
        // Confirm amount to redeem is less than total LUSD minted for collateral
        assert(_LUSDamount <= totals.collDebtAtStart);
